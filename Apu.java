...
public class One {
	...
	private void initialize() {
		...
		JButton btnNewButton_1 = new JButton("Check Ticket Status");
		...
		JLabel lblWelcomeScreen = new JLabel("Welcome to Train Ticketing System");
		...
		JLabel lblWelcomeScreenInstruction = new JLabel("Project Completed by: Apu Chandra Barman");
		...
		lblNewLabel_2_1_1_1.setBounds(25, 112, 238, 14);
		...
		comboBoxFrom.setModel(new DefaultComboBoxModel(new String[] {"Rajkot", "Ahmedabad", "Dwarka"}));
		
		comboBoxTo = new JComboBox();
		comboBoxTo.setModel(new DefaultComboBoxModel(new String[] {"Delhi", "Mumbai", "Kolkata"}));
